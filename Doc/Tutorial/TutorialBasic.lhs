...
> personTable = table "personTable" (genericAdaptor ( tableColumn "name"
>                                                   , tableColumn "age"
>                                                   , tableColumn "address" ))
...
>                        (genericAdaptor Birthday { bdName = tableColumn "name"
...
> employeeTable = table "employeeTable" (genericAdaptor ( tableColumn "name"
>                                                       , tableColumn "boss" ))
...
>                      (genericAdaptor Widget { style    = tableColumn "style"
...
uses of our 'Generic'-derived code.  We use the 'genericAdaptor' to
specify how columns are aggregated.  Note that this is yet another
example of avoiding a headache by keeping your datatype fully
polymorphic, because the 'count' aggregator changes a 'Column String'
into a 'Column Int64'.
...
>         (genericAdaptor Warehouse { wId       = tableColumn "id"
...
>         (genericAdaptor Warehouse { wId       = genericAdaptor (WarehouseId (tableColumn "id"))
>                                   , wLocation = tableColumn "location"
>                                   , wNumGoods = tableColumn "num_goods" })
